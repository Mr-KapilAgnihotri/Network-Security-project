...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        ...
        """initilaizing Knn imputer object with the parameters specified in the training_pipeline.py file and returns a pipeline object with the KNN imputer object as the first step.
        Args:
